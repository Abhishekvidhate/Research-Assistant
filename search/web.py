...
# WE CAN DIRECTLY USE TAVILY/ARXIV RETRIEVERS PROVIDED BY LANGCHAIN
# WITH THOSE RETRIEVERS WE RETRIEVE VECTOR DATA DIRECTLY LIKE
# WE ARE USED TO RETRIEVE IN RAG SYSTEMS
